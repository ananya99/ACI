...
def generate_random_tree_positions(terrain_size, num_trees, min_distance, margin=0.5):
    ...
    for _ in range(num_trees):
        for attempt in range(1000):  # Try a limited number of times
            x = random.uniform(-width + margin, -margin)
...
num_trees = 5  # Example number of trees
...
tree_positions = generate_random_tree_positions(terrain_size, num_trees, min_distance, margin=4)
